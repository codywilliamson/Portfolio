...
const HomeSlide = ({ image }) => {
    ...
    return (
        ...
        <section className="pageHeaderContainer flexHardCenter" style={backgroundImage}>
            ...
            <svg className="yooneekOutline" xmlns="http://www.w3.org/2000/svg" width="769" height="219" viewBox="0 0 769 219" fill="none">
                 <path d="M82.975 54.092H112.813L65.3875 
                            ...
                            109.208 760.862 54.092H731.025L708.412 95.694H692.712V1H665.912Z" stroke="#FFFFFF" strokeWidth="2.5"/>
            </svg>
